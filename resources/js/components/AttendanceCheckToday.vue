        ...
        <tbody>
            <tr v-for="(st, i) in students" :key="i">
                ...
                <td>
                    ...
                    <input type="hidden" :name="'student['+ st.ssi_id + ']'"  v-model="st.attendance.att_status">
                </td>
                <td @click="st.attendance.att_status='late'" v-if="st.attendance.att_status=='present'" class="present status">
                    <i class="fa fa-fw fa-check"></i>
                    <span>Present</span>
                </td>
                <td @click="st.attendance.att_status='absent'" v-if="st.attendance.att_status=='late'" class="late status">
                    <i class="fa fa-fw fa-clock-o"></i>
                    <span>Late</span>
                </td>
                <td @click="st.attendance.att_status='present'" v-if="st.attendance.att_status=='absent'" class="absent status">
                    <i class="fa fa-fw fa-times"></i>
                    <span>Absent</span>
                </td>
                <td class="text-center" style="position:relative;">
                    <attendance-remarks :stud_id="st.ssi_id" :d_remarks="JSON.stringify(st.attendance.remarks)"></attendance-remarks>
                </td>
            </tr>
        </tbody>
    </table>
